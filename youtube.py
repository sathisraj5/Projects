...
#API Key Connect
def api_connect():
    api_id="AIzaSyC-BRJ4oTVBoHR1J_j151PZpD-h3Cs92bY"
...
client = pymongo.MongoClient("mongodb+srv://sathisraj:Sathisraj@cluster0.6lir0su.mongodb.net/?retryWrites=true&w=majority")
